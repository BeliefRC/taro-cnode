        ...
        <View key={item.id} className='topic-info-reply'>
          ...
          <View className='topic-info-reply-right'>
            ...
            <View className='topic-info-reply-right-zan'>
              <Image onClick={this.admire.bind(this, item)} className='topic-info-reply-image-icon'
              ...
              <Image onClick={this.replyToReply.bind(this, item)} className='topic-info-reply-image-icon'
